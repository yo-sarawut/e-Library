...
![51](https://benzneststudios.com/blog/wp-content/uploads/2018/11/51.png) ส่วนปุ่มใช้ class ชื่อว่า **btn** และอยากได้ส้มๆก็ใส่ **btn-warning**
...
เพิ่ม `<div>`ครอบตัว video โดยเพิ่ม class ชื่อว่า `embed-responsive embed-responsive-4by3` `4by3` คือขนาด 4:3 สามารถใช้ตัวอื่นได้เช่น `16by9, 21by9, 1by1`และที่ iframe เพิ่ม class ชื่อว่า `embed-responsive-item`
...
![65](https://benzneststudios.com/blog/wp-content/uploads/2018/11/65.png) การจะเพิ่มแถวของเนื้อหาที่ใช้ class media สามารถใช้  และ  เข้ามาได้
...
เพิ่ม row ไปที่บนสุดของ container ข้างในใช้ list คือ 
...
เพิ่ม jquery , popper , bootstrap ไปที่ท้าย body โดยใช้คำสั่ง   
...
![87](https://benzneststudios.com/blog/wp-content/uploads/2018/11/87.png) ให้ copy โค้ด HTML มาไว้ในที่ต้องการ และ copy CSS ของมันมาด้วย โดยเอาไปวางไว้ใน custom.css ของเรา
