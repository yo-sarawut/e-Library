...
\` df = pd.DataFrame\(data=data\).T df\['IND\_DAY'\] = pd.to\_datetime\(df\['IND\_DAY'\]\) df.dtypes COUNTRY object POP object AREA object GDP object CONT object IND\_DAY datetime64\[ns\] dtype: object
