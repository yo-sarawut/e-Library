...
Displaying Matplotlib Plots[](#displayingmatplotlibplots)
...
Timing Execution[](#timingexecution)
...
Executing Different Languages[](#executingdifferentlanguages)
...
Configuring Logging[](#configur5ing logging)
...
Enhancing Charts with Seaborn[](#enhancingchartswithseaborn)
...
Executing External Code[](#executingexternalcode)
...
Scripted Execution[](#scriptedexecution)
...
On the Command Line[](#onthecommandline)
...
Parameterization with Environment Variables[](#parameterisationwithenvironmentvariables)
...
Parameterization with Papermill[](#parameterisationwithpapermill)
...
Styling Notebooks[](#stylingnotebooks)
...
Working with Databases[](#workingwithdatabases)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NTYwNTA1Nl19
-->