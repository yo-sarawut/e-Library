...
## Full Table of Contents[](https://devguide.python.org/#full-table-of-contents "Permalink to this headline")
...
-   [22. gdb Support](https://devguide.python.org/gdb/)
    ...
    -   [22.3. Updating auto-load-safe-path to allow test_gdb to run](https://devguide.python.org/gdb/#updating-auto-load-safe-path-to-allow-test-gdb-to-run)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NjE4NDc3NV19
-->