...
3. How to rename one or more columns?
...
4. How to apply a function to each element to a series?
...
8. How to create duplicates for other columns for each element in a list of a particular column?
